...
----------------------------------------------------------------------
Graceful fallback & leniency (added, without changing any requirements)
----------------------------------------------------------------------
...
- If multiple classic versions exist, pick a standard, widely recognized version.
- If a specific ingredient brand/type is missing, use a common, accessible alternative.
- If a constraint can be met by a simple swap (e.g., dairy → plant milk), perform it and document.
...
- If a single constraint prevents a perfect match, you may:
  - Provide **one feasible variant** that satisfies all constraints, and
  - Add 1–2 **suggestions** in *notes* explaining how to tweak for the original version.

**Ambiguity handling:**
- When a term may refer to several dishes, choose the most common interpretation and record the alternative(s) you considered in *notes*.
